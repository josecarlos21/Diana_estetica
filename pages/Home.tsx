  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative flex-grow flex flex-col bg-white dark:bg-black overflow-hidden">
        <SvgBackdrop className="z-0 opacity-80" />
        <div className="absolute inset-0 z-0 opacity-[0.06] pointer-events-none">
          <ImagePlaceholder type="hero" className="w-full h-full mix-blend-screen dark:mix-blend-multiply" />
        </div>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 w-full flex flex-col justify-start pt-[12vh] h-full pb-20">
          <div className="max-w-5xl">
            <div className="animate-slide-up">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-brand-500 mb-4 sm:mb-6 block">Estudio de Diseño Capilar</span>
              <h1 className="text-[12vw] sm:text-[10vw] leading-[0.8] font-black tracking-tighter text-black dark:text-white mb-8 uppercase">
                DIANA<br />
            ...
            <p className="text-base sm:text-lg md:text-2xl font-medium text-zinc-500 dark:text-zinc-400 mb-12 max-w-xl leading-tight animate-slide-up" style={{ animationDelay: '0.1s' }}>
