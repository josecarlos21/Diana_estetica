  ...
  return (
    <div className="w-full flex flex-col items-center">
        <div id="printable-ticket" className="w-full max-w-[440px] bg-white text-black font-mono text-sm shadow-2xl p-12 relative border border-zinc-100">
          ...
          <div className="bg-zinc-50 p-8 mb-10 text-center border border-zinc-100">
          ...
          <div className="flex flex-col items-center gap-8">
             <div className="h-14 w-full flex items-stretch gap-[2px] overflow-hidden opacity-80">
                {[...Array(80)].map((_, i) => (
                  <div key={i} className={`bg-black ${Math.random() > 0.3 ? 'flex-[1]' : 'flex-[3]'}`}></div>
                ))}
             </div>
