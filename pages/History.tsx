...
export const History: React.FC = () => {
  const [historyItems, setHistoryItems] = React.useState<BookingHistoryItem[]>([]);
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-12 flex justify-center items-center h-64">
        <div className="w-8 h-8 border-4 border-zinc-200 border-t-brand-500 rounded-full animate-spin"></div>
      </div>
    );
  }
  return (
